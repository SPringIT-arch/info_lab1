...
B - СС Бергманна
nC - симметричная СС с нечетным основанием n (-x записывать как {^x})

!!! При переводе дробных чисел в СС Фибоначчи или факториальную может происходить
!!! потеря данных, т.к. данные СС поддерживают только целые числа
